...
const create = function(pnConfig, globalChannel = 'chat-engine') {
    ...
    */
    class Chat extends Emitter {
        ...
        constructor(channel = new Date().getTime(), private = false) {
            ...
            */
            ...
            let parent = private ? 'private' : 'public';
    ...
    const init = function() {
        ...
        */
        ChatEngine.connect = function(uuid, state = {}) {
            ...
            pnConfig.authKey = pnConfig.uuid;
